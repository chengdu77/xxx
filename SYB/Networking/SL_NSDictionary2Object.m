...
#pragma clang diagnostic pop
                    ...
                    if ( type[0] == '@' )
                    {
                        ...
                        if ( type[0] == _C_INT || type[0] == _C_UINT || type[0] == _C_BOOL || type[0] == _C_SHT || type[0] == _C_BFLD || type[0] == _C_CHR)
                        {
                            ...
                            [object setValue:[NSString stringWithFormat:@"%d",tvalue] forKey:[key stringByReplacingCharactersInRange:NSMakeRange(0,1) withString:topchar]];
                            //                             FQSLog(@"v***:%d k********%@",tvalue,[key stringByReplacingCharactersInRange:NSMakeRange(0,1) withString:topchar]);
                            flag = YES;
                        }
                        else if ( type[0] == _C_ULNG || type[0] == _C_LNG || type[0] == _C_ULNG || type[0] == _C_LNG_LNG )
                        {
                            ...
                            [object setValue:[NSString stringWithFormat:@"%ld",tvalue] forKey:[key stringByReplacingCharactersInRange:NSMakeRange(0,1) withString:topchar]];
                            
                            //                            FQSLog(@"v***:%ld k********%@",tvalue,selectorString);
                            
                            flag = YES;
                        }
                        else if ( type[0] == _C_ULNG_LNG)
                        {
                            //                            FQSLog(@"v***:%@ k********%@",value,key);
        ...
        if ( type[0] == '@' )
        {
            ...
            if ( type[0] == _C_INT || type[0] == _C_UINT || type[0] == _C_BOOL || type[0] == _C_SHT || type[0] == _C_BFLD)
            {
                ...
                if ([value isKindOfClass:[NSString class]]) {
                    int intvalue = (int)[(NSString *)value integerValue];
