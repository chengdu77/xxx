    ...
    if (_showTime){
        ...
        [style setLineBreakMode:NSLineBreakByWordWrapping];
         ...
         CGSize timeSize  = [_message.strTime  boundingRectWithSize:CGSizeMake(300, 100)
                                 ...
                                 attributes:@{ NSFontAttributeName:ChatTimeFont, NSParagraphStyleAttributeName:style}
                                    context:nil].size;
    ...
    switch (_message.type) {
        case UUMessageTypeText:
        {
            ...
            contentSize  = [_message.strContent  boundingRectWithSize:CGSizeMake(ChatContentW, CGFLOAT_MAX)
                                                               options:(NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading)
                                                            attributes:@{NSFontAttributeName:ChatContentFont, NSParagraphStyleAttributeName:style}
                                                               context:nil].size;
