...
- (void)endConvertWithData:(NSData *)voiceData
{
    ...
    [UUProgressHUD dismissWithSuccess:@"完成"];
...
- (void)failRecord
{
    [UUProgressHUD dismissWithSuccess:@"时间太短了"];
...
-(void)addCarema{
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        ...
        //如果没有提示用户
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"温馨提示" message:@"您的设备不具备摄像头" delegate:nil cancelButtonTitle:@"确认" otherButtonTitles:nil];
        [alert show];
    }
}
