...
@interface ChatMainViewController ()<UUInputFunctionViewDelegate,UUMessageCellDelegate,UITableViewDataSource,UITableViewDelegate>
...
- (void)initBar{
    ...
    _btnBack.frame=CGRectMake(0, 0, 65, 35);
...
- (void)segmentChanged:(UISegmentedControl *)segment{
    self.chatModel.isGroupChat = self.isGroupChat;
...
- (void)headImageDidClick:(UUMessageCell *)cell userId:(NSString *)userId{
    ...
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:cell.messageFrame.message.strName message:@"说明－－－－" delegate:nil cancelButtonTitle:@"确认" otherButtonTitles:nil];
    [alert show];
}
