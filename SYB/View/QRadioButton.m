...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"check_unselected"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"check_selected"] forState:UIControlStateSelected];
