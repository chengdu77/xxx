...
-(void)defaultInit{
    ...
    //正常状态下的按钮背景图片
    [_button setImage:[UIImage imageNamed:@"check_unselected"] forState:UIControlStateNormal];
    //选择状态下的按钮背景图片
    [_button setImage:[UIImage imageNamed:@"check_selected"] forState:UIControlStateSelected];
    //添加按钮监听事件
